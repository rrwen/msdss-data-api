...
DEFAULT_METADATA_UPLOADED_AT_COLUMN = 'uploaded_at'
DEFAULT_METADATA_UPLOADED_BY_COLUMN = 'uploaded_by'
DEFAULT_METADATA_UPDATED_AT_COLUMN = 'updated_at'
DEFAULT_METADATA_COLUMNS = [
    ...
    (DEFAULT_METADATA_UPLOADED_AT_COLUMN, 'DateTime'),
    (DEFAULT_METADATA_UPDATED_AT_COLUMN, 'DateTime')
]