...
# -*- coding: utf-8 -*-
#
# msdss_data_api documentation build configuration file
#
...
import os
import sys
sys.path.insert(0, os.path.abspath('../../msdss_data_api'))
...
htmlhelp_basename = 'msdss_data_api_doc'
...
latex_documents = [
    (master_doc, 'msdss_data_api.tex', project.replace('_', '\\_') + ' Documentation',
     author, 'manual'),
]
